import {
  ...
  Delete,
  Get,
  Headers, MethodNotAllowedException, NotImplementedException,
  Param,
  ParseIntPipe, Patch,
  Post,
  Put,
...
export class PostController {
  ...
  async add(
    ...
    const newPost: EventEntity = await this.postService.create(createPostDto, user);
  ...
  async update(
    ...
    const post: EventEntity = await this.postService.update(id, editPostDto, user.id);
