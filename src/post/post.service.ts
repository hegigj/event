...
export class PostService {
  ...
  async getList(filterPostDto?: FilterEventDto): Promise<ListOfDto<EventEntity>> {
    try {
  ...
  async create(createPostDto: CreateEventDto, userDto: UserDto): Promise<EventEntity> {
  ...
  async update(id: number, editPostDto: EditEventDto, userId: number): Promise<EventEntity> {
